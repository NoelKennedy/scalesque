...
namespace Scalesque {
    ...
    /// <summary>
    /// A projection of the Right side of an <see cref="Either{T,U}"/>.  Provides methods for manipulating the potential right value.
    /// </summary>
    ...
    public sealed class RightProjection<T,U>
    {
        ...
        public Option<U> ToOption() {
            return either.Fold(left => Option.None(), Option.Some);
        }
